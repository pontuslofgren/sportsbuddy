...
export default class extends Controller {
  ...
  connect() {
    console.log("Found apiKeyValue: ", this.apiKeyValue)
    console.log("Hello from geocoder")
    console.log("Found addressFieldTarget:", this.addressFieldTarget)
    console.log("Found addressTarget: ", this.addressTarget)
    // console.log("Found mapTarget: ", this.mapTarget)

    // this.marker = null; // used to reset marker

    this.geocoder = new MapboxGeocoder({
      accessToken: this.apiKeyValue,
      types: "country,region", // Removed: "",place,postcode,locality,neighborhood,address"
    })
  ...
  #setInputValue(event) {
    ...
    this.addressTarget.value = position
